<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="mainHome.aspx.cs" Inherits="Bakery_Nhom7.mainHome" %>
<asp:Content ID="Content1" ContentPlaceHolderID="product" runat="server">
    <asp:DataList ID="DataList1" runat="server" DataKeyField="MaSanPham" DataSourceID="SqlDataSource1" RepeatColumns="5" Width="647px">
        <ItemTemplate>
